...
public interface GroovyParserVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by the {@code asyncClosureExprAlt}
	 * labeled alternative in {@link GroovyParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitAsyncClosureExprAlt(@NotNull GroovyParser.AsyncClosureExprAltContext ctx);
	/**
	 * Visit a parse tree produced by the {@code awaitExprAlt}
	 * labeled alternative in {@link GroovyParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitAwaitExprAlt(@NotNull GroovyParser.AwaitExprAltContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code yieldReturnStmtAlt}
	 * labeled alternative in {@link GroovyParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitYieldReturnStmtAlt(@NotNull GroovyParser.YieldReturnStmtAltContext ctx);
	/**
	 * Visit a parse tree produced by the {@code deferStmtAlt}
	 * labeled alternative in {@link GroovyParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitDeferStmtAlt(@NotNull GroovyParser.DeferStmtAltContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GroovyParser#notInstanceofType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitNotInstanceofType(@NotNull GroovyParser.NotInstanceofTypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GroovyParser#keyedPair}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitKeyedPair(@NotNull GroovyParser.KeyedPairContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GroovyParser#enhancedExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitEnhancedExpression(@NotNull GroovyParser.EnhancedExpressionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GroovyParser#dim0}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitDim0(@NotNull GroovyParser.Dim0Context ctx);
	/**
	 * Visit a parse tree produced by {@link GroovyParser#dim1}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	Result visitDim1(@NotNull GroovyParser.Dim1Context ctx);
	/**
