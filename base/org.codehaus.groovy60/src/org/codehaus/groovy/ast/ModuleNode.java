...
public class ModuleNode extends ASTNode {
    ...
    public boolean encounteredUnrecoverableError() {
        return Boolean.TRUE.equals(getNodeMetaData("ParseError"));
    }
    public void setEncounteredUnrecoverableError(boolean error) {
        if (error) putNodeMetaData("ParseError", Boolean.TRUE);
    }
    // GRECLIPSE end
    ...
    public List<ImportNode> getModuleStarImports() {
        return Collections.unmodifiableList(moduleStarImports);
    }
