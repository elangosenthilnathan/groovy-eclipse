...
public class Verifier implements GroovyClassVisitor, Opcodes {
    ...
    public void visitClass(final ClassNode node) {
        ...
        boolean skipGroovify = hasAnnotation(node, new ClassNode(POJO.class))
    ...
    private MethodNode getCovariantImplementation(final MethodNode oldMethod, final MethodNode overrideCandidate, Map<String, ClassNode> genericsSpec, final boolean ignoreError) {
        ...
        if (!equalReturnType) {
            ...
            if (overrideCandidate.isDynamicReturnType() && equalParameters) {
                overrideCandidate.setReturnType(cleanType(omr));
                return null;
            }
            // GRECLIPSE end
        }
